"""
KITTI 2012 stereo dataset implementation
"""
...
class KITTI12Dataset(BaseStereoDataset):
    """
    KITTI 2012 stereo dataset.
    
    Loads colored stereo pairs and disparity maps from KITTI 2012.
    ...
    def _compute_valid_mask(self, disparity: np.ndarray) -> np.ndarray:
        """
        Compute valid pixel mask for KITTI12.
